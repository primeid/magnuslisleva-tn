---
title: "Convergence Toward Platonic Representations in Human and Machine"
excerpt: "An argument that convergent representations in AI and human cognition point toward objective structures in reality and an empirically grounded aesthetic realism."
...
- Huh, M., Cheung, B., Wang, T., and Isola, P. (2024). "The Platonic Representation Hypothesis." *Proceedings of the 41st International Conference on Machine Learning*.
- Aristotle. *Poetics*, chapter 9.
- Spelke, E. S. (1992). "Origins of knowledge." *Psychological Review*, 99(4), 605-632.
- Ekman, P. (1994). "Strong evidence for universals in facial expressions." *Psychological Bulletin*, 115(2), 268-287.
- Izard, C. E. (1994). "Innate and universal facial expressions." *Psychological Bulletin*, 115(2), 288-299.
- Sauter, D. A., Eisner, F., Ekman, P., and Scott, S. K. (2010). "Cross-cultural recognition of basic emotions through nonverbal emotional vocalizations." *PNAS*, 107(6), 2408-2412.
- Mortillaro, M., Mehu, M., and Scherer, K. R. (2024). "How emotion is experienced and expressed in multiple cultures." *Frontiers in Psychology*, 15, 1350631.
- Halberda, J., and Feigenson, L. (2008). "Developmental change in the acuity of the number sense." *Developmental Psychology*, 44(5), 1457-1465.
- Izard, V., Sann, C., Spelke, E. S., and Streri, A. (2011). "Predicting sights from sounds." *Infancy*, 16(5), 442-451.
...
- Spehar, B., Clifford, C. W. G., Newell, B. R., and Taylor, R. P. (2003). "Universal aesthetic of fractals." *Computers & Graphics*, 27(5), 813-820.
- Taylor, R. P., Spehar, B., Van Donkelaar, P., and Hagerhall, C. M. (2011). "Perceptual and physiological responses to Jackson Pollock's fractals." *Frontiers in Human Neuroscience*, 5, 60.
- Robles, K. E., Liaw, N. A., Taylor, R. P., Baldwin, D. A., and Sereno, M. E. (2020). "A shared fractal aesthetic across development." *Humanities and Social Sciences Communications*, 7, 158.
- Koch, M., Denzler, J., and Redies, C. (2010). "1/f² characteristics and isotropy in the Fourier power spectra of visual art." *PLoS ONE*, 5(8), e12268.
- Redies, C., and Brachmann, A. (2017). "Statistical image properties in large subsets of traditional art, bad art, and abstract art." *Frontiers in Neuroscience*, 11, 593.
- Street, N., Forsythe, A. M., Reilly, R. G., Taylor, R. P., and Helmy, M. S. (2016). "Universal preference vs. individual differences in aesthetic response to fractal patterns." *Frontiers in Human Neuroscience*, 10, 213.
- Wang, X., Men, W., Gao, J., Caramazza, A., and Bi, Y. (2020). "Neural representations of abstract concepts." *Cerebral Cortex*, 30(4), 2157-2166.
- Vargas, R., and Just, M. A. (2022). "Neural representations of abstract concepts across English and Mandarin." *Human Brain Mapping*, 43(15), 4587-4600.
- Botch, T. L., and Finn, E. S. (2024). "Neural representations of concreteness are specific to the individual." *Journal of Neuroscience*, 44(45), e0288242024.
...
- Vessel, E. A., Starr, G. G., and Rubin, N. (2012). "The brain on art." *Frontiers in Human Neuroscience*, 6, 66.
- Vessel, E. A., Isola, P., Marti, A., Leder, H., and Rubin, N. (2019). "The default-mode network represents aesthetic appeal across visual domains." *PNAS*, 116(38), 19155-19164.
...
- Sachs, M. E., Kaplan, J., Cades, C., Habibi, A., and Damasio, A. (2024). "Movement synchrony among dance performers predicts brain synchrony among spectators." *Scientific Reports*, 14, 22583.
- Han, S., and Ma, Y. (2014). "Cultural differences in human brain activity." *NeuroImage*, 99, 293-300.
- Kitayama, S., and Park, J. (2021). "Functional connectome fingerprint of holistic-analytic cultural style." *Social Cognitive and Affective Neuroscience*, 16(8), 850-857.
- Levinson, S. C. (2003). *Space in Language and Cognition*.
- Paige, L. E., Ksander, J. C., Johndro, H. A., and Gutchess, A. H. (2017). "Cross-cultural differences in the neural correlates of recognition." *Cortex*, 91, 250-261.
- Broom, T. W., Iyer, S., Courtney, A. L., and Meyer, M. L. (2024). "Loneliness corresponds with neural representations and language use that deviate from shared cultural perceptions." *Communications Psychology*, 2, 40.
...
- Umilta, M. A., Berchio, C., Sestito, M., Freedberg, D., and Gallese, V. (2012). "Abstract art and cortical motor activation." *Frontiers in Human Neuroscience*, 6, 311.
- Sasaki, Y., Vanduffel, W., Knutsen, T., Tyler, C., and Tootell, R. (2005). "Symmetry activates extrastriate visual cortex." *PNAS*, 102(8), 3159-3163.
- Rabbas, O., Apelseth, A., Apeland, A. L., and Stigen, A. (eds.) (2023). *Det gode*, chapter 10.
